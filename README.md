...
| `defectDojoEvalProductDescription`       | `false`                     | Evaluate product description as a Python expression. Enable only for trusted, administrator-controlled configuration.                                                                         |
...
| `defectDojoEvalTags`                     | `false`                     | Evaluate `defectDojoTags` as a Python expression that returns a list of strings. Enable only for trusted, administrator-controlled configuration.                                               |
| `defectDojoApplyTagsToFindings`          | `false`                     | Apply `defectDojoTags` from the reimport to Findings created or imported by DefectDojo.                                                                                                       |
| `defectDojoApplyTagsToEndpoints`         | `false`                     | Apply `defectDojoTags` from the reimport to Endpoints created or imported by DefectDojo when the scan produces endpoints.                                                                     |
| `defectDojoVersion`                      | *(empty)*                   | Optional textual version sent with the reimport only when non-empty.                                                                                                                           |
| `defectDojoEvalVersion`                  | `false`                     | Evaluate `defectDojoVersion` as a Python expression returning a textual version. Enable only for trusted, administrator-controlled configuration.                                              |
| `defectDojoApplyTagsToProduct`           | `false`                     | Apply `defectDojoTags` to a newly created Product when auto-create is enabled; existing Products are not changed.                                                                              |
| `defectDojoEnableProductTagInheritance`  | `false`                     | Enable tag inheritance on a newly created Product when auto-create is enabled; existing Products are not changed.                                                                              |
...
| `defectDojoProductDescription`           | `Created by trivy-dojo-report-operator` | Description assigned to a newly created Product in DefectDojo.                                                                                                                                |
...
| `defectDojoTags`                         | *(empty)*                   | Tags for the DefectDojo Test. With `defectDojoEvalTags=false`, use a comma-separated list; with it enabled, use a Python expression returning a list of strings. A non-empty list replaces existing Test tags. |
